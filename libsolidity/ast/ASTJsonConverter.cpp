...
bool ASTJsonConverter::visit(ImportDirective const& _node)
{
	...
	for (auto const& symbolAlias: _node.symbolAliases())
        	//??: how to cast symbolAlias[0] and symbolAlias[1] to a pair that i can append to json::objectValue?
        	symbolAliases.append( ??? )        

        //another concern I am having is that these could be partially or completely nil
        */    
	addJsonNode(_node, "ImportDirective", {
        	make_pair("file", _node.path()),
                  ...
                  // is that enough to identify it by?
                  //maybe
